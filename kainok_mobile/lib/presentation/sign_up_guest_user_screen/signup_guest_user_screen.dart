...
class SignUpGuestUserScreen extends GetWidget<SignUpGuestUserController> {
  ...
  //     if (googleUser != null) {
  //       print("googleUserguestsignup");
  //       print(googleUser);
  //       dynamic names = googleUser;
  //       dynamic firstName = names[0].toString();
  //       //String middleName = names[1];
  //       dynamic lastName = names[2].toString();
  //       controller.signUpGuestUser(
  //           firstName: firstName,
  //           lastName: lastName,
  //           email: googleUser,
  //           mobileNumber: "",
  ...
  //       //Get.offNamed(AppRoutes.homeScreenPage, arguments: {
  ...
  Future<String?> onTapGoogleSignIn() async {
    ...
    if (googleUser != null && googleUser.serverAuthCode == null) {
      print("googleUsersignup");
      print(googleUser);
      print("onTapGoogleSignIn signup");
      print(googleUser);
  ...
  onTapSaveDetails() async {
    if (controller.selected.value == true) {
      await controller.signUpGuestUser(
          firstName: controller.firstnameController.text,
          lastName: controller.lastnameController.text,
          email: controller.emailController.text,
          mobileNumber: controller.mobileNoController.text,
          city: controller.currentLatitude.toString() +
              "," +
              controller.currentLongitude.toString(),
