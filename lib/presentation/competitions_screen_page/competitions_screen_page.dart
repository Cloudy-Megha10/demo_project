...
import 'controller/competitions_screen_controller.dart';

class CompetitionsScreenPage extends GetView<CompetitionsScreenController> {
  @override
  Widget build(BuildContext context) {
    var data = Get.arguments;
    CompetitionsScreenController controller =
        Get.put(CompetitionsScreenController());
    CategoryListingController categoryListingController =
        Get.put(CategoryListingController());
    final compImageListingController = Get.put(CompImageListingController());
    ...
    return WillPopScope(onWillPop: () async {
      ...
      for (final competition in controller.competitions.value) {
      ...
      return DefaultTabController(
          ...
          child: SafeArea(
            ...
            //     centerTitle: true,
            //     title: Padding(
            //       padding: getPadding(left: 15, right: 15, top: 10),
            //       child: Container(
            //         height: getSize(60),
            //         decoration: AppDecoration.searchViewBoxDecoration.copyWith(
            ...
            //         //           height: getSize(24),
            //         //           width: getSize(24),
            //         //           margin: getMargin(left: 8, top: 0, bottom: 8),
            //         //         ),
            //         //       ),
            //         //       onChanged: (value) {
            //         //         controller.filterCompetition(value);
            //         //       },
            ...
            //                       width: getSize(24),
            //                       margin:
            //                           getMargin(left: 8, top: 8, bottom: 8))),
            //               onChanged: (value) {
            //                 controller.filterCompetition(value);
            //               },
            //               textAlign: TextAlign.left,
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.only(
                                          left: 25, top: 20),
                                      child: Text("msg_trending_competition".tr,
                                          overflow: TextOverflow.ellipsis,
                                          textAlign: TextAlign.left,
                                          style: AppStyle.blackBold16F),
                                    ),
                                    SizedBox(
                                      height: 10,
                                    ),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        style: controller.current.value ==
                                                                            ...
                                                                            ? TextStyle(
                                                                                ...
                                                                                fontFamily: "Aller")
                                                                            : TextStyle(color: ColorConstant.gray600, fontFamily: "Aller"),
                                                                      ),
                                                                    ),
                                                                    SizedBox(
                                                                      width: 10,
                                                                ...
                                                                child: Column(
                                                                  children: [
                                                                    GestureDetector(
                                                                      child:
                                                                          CircleAvatar(
                                                                        backgroundImage: competition.imageLocation.isNotEmpty
                                                                            ? NetworkImage(competition
                                                                                .imageLocation)
                                                                            : AssetImage(ImageConstant.imgUploadPng)
                                                                                as ImageProvider,
                                                                        radius:
                                                                            50,
                                                                        backgroundColor:
                                                                ...
                                                                children: [
                                                                  competitions.length >
                                                                      ...
                                                                      ? GestureDetector(
                                                                          onTap:
                                                                              () {
                                                                            categoryListingController.participationCompetitionsByCategoryGetApi(competitions.first.categoryId,
                                                                                true);
                                                                          },
                                                                          child:
                                                                              CircleAvatar(
                                                                            child:
                                                                                CircleAvatar(
                                                                              child: Text("lbl_view_all".tr, style: TextStyle(color: ColorConstant.gray900, fontSize: getFontSize(14), fontFamily: 'Aller', fontWeight: FontWeight.w400, letterSpacing: getHorizontalSize(0.25), decoration: TextDecoration.underline)),
                                                                              radius: 50,
  ...
  void getCurrentWidget(
      BuildContext context, CompetitionsScreenController controller) {
  ...
  onTapCompetitions(String compId, String compTitle) {
